...
expName = 'flankers_task_final'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\Desktop\\psychopie_final\\solo project\\flankers_task_final_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Welcome!\n\nIn this task, you will see rows of arrows on the screen.\n\nYour job is to respond based on the direction of the relevant arrow while ignoring the other arrows (the flankers).\n',
        font='Arial',
